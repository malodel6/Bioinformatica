...
Le decimos que está anotado, y el tipo de formato en el que está (json lines)
Luego le decimos el formato en el que lo queremos con dataformat.
...
# Muestra todas las filas que son duplicados
duplicated(genomas)
```
...
Que el nombre de la 7 comienza por GCF y el de la 8 por GCA
