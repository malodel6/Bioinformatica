...
#Notas
Se puede crear un historial de versiones con git al ir ejecutando commits, y se puede volver a una versión anterior por si cometemos algún error. También se pueden crear diferentes ramas, aunque en nuestro caso no lo vamos a usar, y se puede tener activa solo una rama, mostrándose una sola en git (la activa se mostraria con el *)